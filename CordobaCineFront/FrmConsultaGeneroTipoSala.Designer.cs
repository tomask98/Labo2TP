namespace CordobaCineApp.Presentacion
{
    partial class FrmConsultaGeneroTipoSala
    {
        ...
        private void InitializeComponent()
        {
            ...
            checkedListBox1.Items.AddRange(new object[] { "Accion     ", "Comedia", "Terror", "Drama", "Documental", "Ciencia ficción" });
            checkedListBox1.Location = new Point(254, 365);
            checkedListBox1.Margin = new Padding(5, 3, 5, 3);
            checkedListBox1.MultiColumn = true;
            checkedListBox1.Name = "checkedListBox1";
            checkedListBox1.Size = new Size(543, 22);
            ...
            lblDgv.Location = new Point(27, 478);
